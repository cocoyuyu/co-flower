    ...
    <header class="headerbar">
      <div class="headerbar-content">
        ...
        <div class="headerbar-content-center">
          <a href="/home/searching">搜索鲜花、蛋糕、礼品</a>
        </div>
      </div>
    </header>
    <!--SearchHeaderBar end-->
      ...
      <section class="catebox-details">
        <article id="hot" name="hot" class="catebox-details-mode active">
          <header class="catebox-details-banner">
            <a class="navigation" href="https://m.hua.com/theme/mothersday/">
              <img
                src="https://img02.hua.com/slider/20_mothersday_all.jpg"
                alt=""
              />
            </a>
          </header>
        ...
        <article id="flower" name="flower" class="catebox-details-mode">
          <header class="catebox-details-banner">
            ...
            <div class="catebox-details-title">
              ...
              <div class="catebox-details-title-right">
                <a href="/ranking/" class="navigation"
                  ><i class="iconfont iconfont-trophy"></i>鲜花排行榜</a
                >
              </div>
            </div>
        ...
        <article id="ppf" name="ppf" class="catebox-details-mode">
          <header class="catebox-details-banner">
            ...
            <div class="catebox-details-title">
              ...
              <div class="catebox-details-title-right">
                <a href="/ranking/?type=ppf" class="navigation"
                  ><i class="iconfont iconfont-trophy"></i>永生花排行榜</a
                >
              </div>
            </div>
        ...
        <article id="cake" name="cake" class="catebox-details-mode">
          <header class="catebox-details-banner">
          ...
          <div class="catebox-details-body">
            ...
            <nav class="catebox-details-list catebox-details-list-square">
              ...
              <div class="catebox-details-row">
                ...
                <div
                  class="catebox-details-item catebox-details-list-square"
                ></div>
              </div>
            </nav>
          </div>
        </article>
        <article id="gift" name="gift" class="catebox-details-mode">
          <header class="catebox-details-banner">
        ...
        <article id="plant" name="plant" class="catebox-details-mode">
          <header class="catebox-details-banner">
